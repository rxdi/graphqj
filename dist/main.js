...
},{"../app/app.tokens":"app/app.tokens.ts","./parse-ast":"helpers/parse-ast.ts","./parse-args-schema":"helpers/parse-args-schema.ts","./parse-types.schema":"helpers/parse-types.schema.ts","./isFunction":"helpers/isFunction.ts","./lazy-types":"helpers/lazy-types.ts"}],"helpers/basic-schema.ts":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
value: true
});
...
},{"./load-file":"helpers/load-file.ts","./traverse/traverse":"helpers/traverse/traverse.ts"}],"app/app.module.ts":[function(require,module,exports) {
"use strict";
...
watch_bundles_1.watchBundles(traverse_map_1.traverseMap.map(f => f.path), config, bootstrap);
return true;
})
}]
})], AppModule);
